#THANKS TO LUKMAN
#lukman gw ijin recode
#thanks to author asli
#THANKS TO ALLAH SWT
#YA TESELAH DAH
...
USN="Mozilla/5.0 (Macintosh; Intel Mac OS X 11_10) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4652.70 Safari/537.36"
...
def banner():
	...
	prints(Panel(f'''{O2}         "https://github.com/arvel-noob  083843614174"{color_rich}
_____ _____________  ____________________ {H2}•{P2} Author : Ansyah arvel{color_rich}
__  // /__  /___   |/  /__  __ )__  ____/ {H2}•{P2} Facebook : ansyah arvel{color_rich}
_  // /__  / __  /|_/ /__  __  |_  /_     {H2}•{P2} Status : {H2}Premiun{color_rich}
/__  __/  /___  /  / / _  /_/ /_  __/     {H2}•{P2} Team   : Gak ada{color_rich}
...
def key():
	...
	try:ses = requests.Session();asu = ses.get("https://app.cryptolens.io/api/key/Activate?token=WyIyNTYzMTUwMyIsIjlJNmI2M3lTcGtackhEaCtyc2JTLzlBZWZLdzZLYTJyZU4rNDNBZk4iXQ==&ProductId=16754&Key=%s&Sign=True"%(key)).json()['licenseKey']['key'];open("data/lisensi.txt","w").write(key);prints(Panel(f"{P2}selamat lisensi kamu aktif, tolong gunakan tools ini dengan bijak",width=80,padding=(0,4),style=f"{color_table}"));time.sleep(4);login_kamu()
		...
		prints(Panel(f"{P2} lisensi yang anda masukan tidak terdaftar silahkan beli terlebih dahulu",width=80,padding=(0,1),style=f"{color_table}"));os.system("xdg-open https://wa.me/6283843614174?text=assalamualaikum+bang+mau+beli+lisensi+crack+Instagram");time.sleep(2);exit()
